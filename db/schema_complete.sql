-- =====================================================
-- 完整的数据库架构 - 包含所有 updated_at 列
-- 这个文件用于新建数据库或完全重建
-- 使用方法: wrangler d1 execute cem-db --file=db/schema_complete.sql
-- =====================================================
...
-- 默认管理员账号
-- ===================
INSERT OR IGNORE INTO users (email_prefix, email_password, user_type)
